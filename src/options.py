...
class Options():
    ...
    def initialize_parser(self):
        # basic parameters
        self.parser.add_argument('--name', type=str, default='test_model', help='name of the experiment')
        ...
        # dataset parameters
        self.parser.add_argument('--train_data', type=str, default='none',
        ...
        self.parser.add_argument('--use_gpt', action='store_true')
